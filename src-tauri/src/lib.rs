...
//
// Push notifications are handled by Firebase Cloud Messaging (FCM) on Android.
// The FCM integration is done in Kotlin (MainActivity.kt and GoaldyFirebaseMessagingService.kt).
